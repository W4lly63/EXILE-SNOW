...
WY_fnc_SnowFootSteps = {
  ...
  private["_house","_speedP","_soundPath","_soundToPlay","_soundStepsNumb","_soundStepsSelected","_sleepL","_sleepR","_ssVolume","_ssDistance","_overShoreS","_overWaterS","_moveD","_playerWlk","_playerRun","_playerEva","_playerStop"];
